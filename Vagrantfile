...
templates = {
  'cassandra21x' => { 
    ...
    copy: [ '.vagrant/default-cassandra', '.vagrant/cassandra21x.yaml', '.vagrant/CaOps.yaml', './bin/CaOps', '.vagrant/CaOps.service' ], 
    exec: { 
  ...
  'cassandra39x' => { 
    dist: 'ubuntu/xenial64', mem: 1024, cpus: 1,
    copy: [ '.vagrant/default-cassandra', '.vagrant/cassandra39x.yaml', '.vagrant/CaOps.yaml', './bin/CaOps', '.vagrant/CaOps.service' ], 
    exec: { 
